...
| chaos-exporter.image.tag | string | `"1.38.0"` |  |
...
| chaos-operator.image.tag | string | `"1.38.0"` |  |
...
| subscriber.upgrader.image.tag | string | `"1.38.0"` |  |
| subscriber.version | string | `"1.38.0"` |  |
